...
export const AuthItemCreate = Auth(ItemCreate, "planner");
export const AuthPlannerMyPage = Auth(PlannerPage, "planner");
export const AuthPortfolioCreate = Auth(PortfolioCreate, "planner");
